...
<div class="py-5" id="elements">
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6">
                <h4 class="elements-title fw-bold mb-4"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">권수별</font></font></h4>
            ...
            <div class="col-lg-6">
                <h4 class="elements-title fw-bold mb-4"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">아직 읽은 책이 없습니다</font></font></h4>
