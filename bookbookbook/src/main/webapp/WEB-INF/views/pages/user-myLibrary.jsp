			                    ...
			                    <div class="tab-pane fade" id="nav-read" role="tabpanel" aria-labelledby="nav-read-tab" tabindex="0">
			                        <div id="read-list">
			                            ...
			                            <div class="book-item d-flex align-items-start mb-4">
			                                <img src="placeholder.jpg" alt="책 표지" class="book-cover me-3" style="width: 100px; height: 150px;">
			                                <div class="book-info flex-grow-1">
			                                    <div class="d-flex justify-content-between align-items-start">
			                                        <div>
			                                            <h5 class="book-title">도서명</h5>
			                                            <p class="book-author mb-1">저자</p>
			                                            <div class="book-rating mb-1">★★★★☆</div>
			                                            <p class="book-dates">시작 2024.06.15 종료 2024.06.18</p>
			                                        </div>
			                                        <!-- 2번: 추가 버튼 -->
			                                        <button class="btn btn-sm">
			                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256"><path d="M229.66,58.34l-32-32a8,8,0,0,0-11.32,0l-96,96A8,8,0,0,0,88,128v32a8,8,0,0,0,8,8h32a8,8,0,0,0,5.66-2.34l96-96A8,8,0,0,0,229.66,58.34ZM124.69,152H104V131.31l64-64L188.69,88ZM200,76.69,179.31,56,192,43.31,212.69,64ZM224,128v80a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V48A16,16,0,0,1,48,32h80a8,8,0,0,1,0,16H48V208H208V128a8,8,0,0,1,16,0Z"></path></svg>
			                                        </button>
			                                    </div>
			                                </div>
			                            </div>
			                        ...
			                        <div id="reading-list">
			                            ...
			                            <div class="book-item d-flex align-items-start mb-4">
			                                ...
			                                <div class="book-info flex-grow-1">
			                                    <div class="d-flex justify-content-between align-items-start">
			                                        <div>
			                                            <h5 class="book-title">세이노의 가르침(70만부 기념 빨간띠판)</h5>
			                                            <p class="book-author mb-1">저자</p>
			                                            <p class="book-start-date mb-1">시작 2024.06.15</p>
			                                        </div>
			                                        <!-- 2번: SVG 버튼 -->
			                                        <button class="btn btn-sm ">
			                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256"><path d="M229.66,58.34l-32-32a8,8,0,0,0-11.32,0l-96,96A8,8,0,0,0,88,128v32a8,8,0,0,0,8,8h32a8,8,0,0,0,5.66-2.34l96-96A8,8,0,0,0,229.66,58.34ZM124.69,152H104V131.31l64-64L188.69,88ZM200,76.69,179.31,56,192,43.31,212.69,64ZM224,128v80a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V48A16,16,0,0,1,48,32h80a8,8,0,0,1,0,16H48V208H208V128a8,8,0,0,1,16,0Z"></path></svg>
			                                    ...
			                                    <p class="book-progress mb-0">64% (473/736 페이지)</p>
			                                </div>
			                            </div>
			                        </div>
			                        <!-- 4번: 정렬 버튼 -->
